    ...
    return (
        < div className='my-20 '>
            <div className='flex justify-center items-center md:gap-3'>
                <h1 className='md:text-6xl text-3xl font-light text-[#091A2D]'>Placement</h1>
                <h1 className='md:text-6xl text-3xl italic font-semibold text-[#F8D958] dancing-script'>Benefits</h1>
            </div>
            <div className='grid lg:grid-cols-3 w-[90%] md:mx-auto grid-cols-2 md:gap-10 gap-5 mx-5 mt-32'>
                <div className='md:space-y-3 space-y-1'>
                    {/* <div className='bg-[#0B2642] w-12 h-12 rounded-full'></div> */}
                    <img src='./icon1.png' alti="con1" className='w-12 h-12' />
                    <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>Profiles highlighted on hirist.com</h1>
                    <p className='text-[#636363] md:text-xl text-[8px] font-light'>Make a distinct mark for yourself<br /> on India's leading job portal.</p>
                </div>
                <div className='md:space-y-3 space-y-1'>
                <img src='./icon2.png' alti="con1" className='w-12 h-12' />
                <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>300+ monthly job opportunities</h1>
                ...
                <img src='./icon3.png' alti="con1" className='w-12 h-12' />
                    <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>800+ monthly job openings</h1>
                ...
                <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>Dedicated placement coach</h1>
                ...
                <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>50+ Members placement team</h1>
                ...
                <h1 className='text-[#091A2D] md:text-2xl text-sm font-bold'>Jobs opening sent everyday</h1>
