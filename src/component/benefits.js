    ...
    return (
        < div className='my-20 '>
            ...
            <div className='grid lg:grid-cols-3 w-[87%] md:mx-auto grid-cols-2 md:gap-10 gap-5 mx-8 md:mt-32 mt-5'>
                ...
                <div className='md:space-y-3 space-y-1 md:w-80'>
                <img src='./icon2.jpg' alti="con1" className='md:w-10 md:h-10 w-8 h-8' />
                ...
                <img src='./icon3.jpg' alti="con1" className='md:w-10 md:h-10 w-8 h-8' />
                ...
                <div className='md:space-y-3 space-y-1 md:w-80'>
                <img src='./icon4.jpg' alti="con1" className='md:w-10 md:h-10 w-8 h-8' />
                ...
                <div className='md:space-y-3 space-y-1 md:w-80'>
                <img src='./icon5.jpg' alti="con1" className='md:w-10 md:h-10 w-8 h-8' />
                ...
                <div className='md:space-y-3 space-y-1 md:w-80'>
                <img src='./icon6.jpg' alti="con1" className='md:w-10 md:h-10 w-8 h-8' />
