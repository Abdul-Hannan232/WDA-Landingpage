...
export default function Students({ title, color, textColor, boxbg, text, font }) {
    return (
        <div className={`pd:py-28 bg-[#F6F4F4] py-10 ${color}`}>
            <h1 className={`md:text-5xl text-xl md:w-[700px] w-[300px] font-extrabold mx-auto ${textColor} ${font} text-center`}>{title}</h1>
            <div className='flex flex-wrap justify-center items-center gap-10 md:mt-20 mt-5'>
                <div className='md:w-80 relative'>
                    <img src="dots.png" className='absolute md:-left-10 -left-5 top-40' />
                    <div className={`${boxbg} md:w-72 w-60 relative top-0 h-80 md:mt-0 mt-10 rounded-[30px] p-6 text-center`}>
             ...
             <div className='md:w-80 relative'>
             <div className={`${boxbg} lg:w-80 z-20 md:w-72 w-60 relative top-0 md:mt-0 mt-10 lg:h-96 h-80 rounded-[30px] p-6 text-center`}>
                ...
                <img src="dots.png" className='absolute md:hidden block md:-left-10 -left-5 top-40' />
                </div>

                <div className='md:w-80 relative'>
                    <div className={`${boxbg} md:w-72 w-60  z-20 relative top-0 h-80 md:mt-0 mt-10 rounded-[30px] p-6 text-center`}>
                    ...
                    <img src="dots.png" className='absolute  md:-top-16 md:left-24 -left-5 top-40' />
                </div>
