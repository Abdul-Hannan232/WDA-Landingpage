                ...
                {data.map((items) => (
                    <>
                        <div className={`teamBg w-80 relative top-0 md:mt-0 mt-10  rounded-[30px] p-6 text-center`}>
                            ...
                            <h1 className={`text-2xl mt-20 text-[#091A2D] font-bold Aileron-bold `}>{items.name}</h1>
                            <p className='text-[#091A2D] text-md font-bold text-center  Aileron'>{items.designation}</p>
                            ...
                            <p className={`text-center text-sm mx-5 my-5 text-[#091A2D] Aileron`}>{items.para}</p>
                            <a href="#" className='text-[#436DAB] text-lg underline Aileron-bold  text-center'>Linkedin Profile</a>
                        </div>
                    </>
                ))}
